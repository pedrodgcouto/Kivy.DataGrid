...
<TableHeader>:
	background_normal: 'background_header.png'
	background_down: 'background_header.png'
	size_hint_x: 0.5
...
class MainScreen(Screen):
	def __init__(self, **kwargs):
		...
		table_header = [['ID', 'center', 'center', 'string', 0.1, 'hidden'], ['Field 01', 'center', 'left', 'option', 0.4, 'visible'], ['Field 02', 'center', 'right', 'number', 0.3, 'visible'], ['Field 03', 'center', 'right', 'coin', 0.2, 'visible']]
		table_body = [
						['01', 'Item 01',	'12', '1.8'], 
						['02', 'Item 02',	'43', '1.8'], 
						['03', 'Item 03', 	'3', '1.8'], 
		...
		scroll = ScrollView(size_hint=(1, 1), _size=(400, 500000), scroll_y=0, pos_hint={'center_x':.5, 'center_y':.5}, effect_y=None, scroll_distance=0)
